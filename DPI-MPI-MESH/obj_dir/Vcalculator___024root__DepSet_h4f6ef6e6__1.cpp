...
#endif
            VL_FATAL_MT("calculator.v", 5, "", "Input combinational region did not converge.");
        }
...
#endif
            VL_FATAL_MT("calculator.v", 5, "", "NBA region did not converge.");
        }
...
#endif
                VL_FATAL_MT("calculator.v", 5, "", "Active region did not converge.");
            }
