...
def get_loss(params, curr_data, variables, iter_time_idx, loss_weights, use_sil_for_loss,
    ...
    rgb_timer = ModuleTimer(rgb_renderer, name="rgb_renderer")
    depth_timer = ModuleTimer(depth_renderer, name="depth_renderer")
    ...
    for time_idx in tqdm(range(checkpoint_time_idx, num_frames)):
        ...
        if time_idx > 0 and not config['tracking']['use_gt_poses']:
            ...
            while True:
                ...
                loss, variables, losses, timers = get_loss(params, tracking_curr_data, variables, iter_time_idx, config['tracking']['loss_weights'],
